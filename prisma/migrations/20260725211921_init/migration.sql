...
-- CreateEnum
CREATE TYPE "PairingCategory" AS ENUM ('CARNE', 'PEIXE', 'MASSA', 'QUEIJO', 'SOBREMESA', 'VEGETARIANO', 'OCASIAO', 'OUTRO');

-- CreateEnum
CREATE TYPE "PairingIntensity" AS ENUM ('LEVE', 'MEDIA', 'INTENSA');
...
CREATE TABLE "GastronomicSuggestion" (
    ...
    "title" TEXT NOT NULL,
    "category" "PairingCategory" NOT NULL,
    "description" TEXT,
